    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo url($siteBase ?? BASE_PATH); ?>" class="text-white/70 hover:text-primary transition-colors text-sm flex items-center gap-2"><i class="fas fa-chevron-left text-xs text-primary/50"></i> الرئيسية</a></li>
                    <li><a href="<?php echo url(($siteBase ?? BASE_PATH) . '/services'); ?>" class="text-white/70 hover:text-primary transition-colors text-sm flex items-center gap-2"><i class="fas fa-chevron-left text-xs text-primary/50"></i> خدماتنا</a></li>
                    <li><a href="<?php echo url(($siteBase ?? BASE_PATH) . '/about'); ?>" class="text-white/70 hover:text-primary transition-colors text-sm flex items-center gap-2"><i class="fas fa-chevron-left text-xs text-primary/50"></i> من نحن</a></li>
                    <li><a href="<?php echo url(($siteBase ?? BASE_PATH) . '/gallery'); ?>" class="text-white/70 hover:text-primary transition-colors text-sm flex items-center gap-2"><i class="fas fa-chevron-left text-xs text-primary/50"></i> أعمالنا</a></li>
                    <li><a href="<?php echo url(($siteBase ?? BASE_PATH) . '/contact'); ?>" class="text-white/70 hover:text-primary transition-colors text-sm flex items-center gap-2"><i class="fas fa-chevron-left text-xs text-primary/50"></i> اتصل بنا</a></li>
                </ul>
            </div>
                ...
                <ul class="space-y-3">
                    <?php if (!empty($services)): ?>
                        <?php foreach (array_slice($services, 0, 5) as $svc): ?>
                            <li>
                                <a href="<?php echo url(($siteBase ?? BASE_PATH) . '/service/' . ($svc->slug ?? '')); ?>" class="text-white/70 hover:text-primary transition-colors text-sm flex items-center gap-2">
    ...
    <div class="border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
                ...
                <a href="<?php echo url($siteBase ?? BASE_PATH); ?>" class="text-primary text-sm hover:text-accent transition-colors">ركاز للصيانة</a>
            </div>
        </div>
    </div>
</footer>
