...
<footer class="relative z-10 border-t border-white/10 bg-black/20 backdrop-blur-xl">
    <div class="px-6 lg:px-20 py-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
            <div class="flex items-center gap-3 mb-5">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-xs">خدمات احترافية عالية الجودة</p>
                </div>
            </div>
        ...
        <!-- Services Links -->
        <div>
            <h4 class="text-lg font-bold mb-5">الخدمات</h4>
            <ul class="space-y-3 text-gray-400 text-sm">
                <?php if (!empty($services)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <li><a href="#" class="hover:text-cyan-400 transition">خدماتنا</a></li>
                    <li><a href="#" class="hover:text-cyan-400 transition">حلول مخصصة</a></li>
                <?php endif; ?>
            </ul>
        </div>
        ...
        <!-- Quick Links -->
        <div>
            <h4 class="text-lg font-bold mb-5">روابط سريعة</h4>
            <ul class="space-y-3 text-gray-400 text-sm">
        ...
        <!-- Contact Info -->
        <div>
            <h4 class="text-lg font-bold mb-5">معلومات التواصل</h4>
    ...
    <div class="border-t border-white/10 py-6 text-center text-gray-500 text-sm">
        &copy; <?= $year ?> جميع الحقوق محفوظة — <?= $siteName ?>
    </div>
</footer>
