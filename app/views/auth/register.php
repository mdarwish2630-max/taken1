...
<head>
    ...
    <title><?= lang('register') ?> - <?= SITE_NAME ?></title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle"><?= lang('register') ?></p>
            </div>
            ...
            <div class="auth-body">
                ...
                <form method="POST" action="<?= url('/register') ?>">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-icon-wrapper">
                                <input type="password" name="password" id="passwordInput" class="form-control" required
                                       placeholder="<?= lang('password') ?>" minlength="8">
                                <i class="fas fa-lock input-icon"></i>
                                <button type="button" class="password-toggle toggle-pass" data-target="passwordInput" aria-label="Toggle password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-wrapper">
                                <input type="password" name="confirm_password" id="confirmInput" class="form-control" required
                                       placeholder="<?= lang('confirm_password') ?>">
                                <i class="fas fa-lock input-icon"></i>
                                <button type="button" class="password-toggle toggle-pass" data-target="confirmInput" aria-label="Toggle password">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <label class="terms-check">
                        ...
                        <span><?= lang('agree_terms') ?? 'أوافق على' ?> <a href="#"><?= lang('terms') ?? 'الشروط والأحكام' ?></a> <?= lang('and') ?? 'و' ?> <a href="#"><?= lang('privacy') ?? 'سياسة الخصوصية' ?></a></span>
                    </label>
                ...
                <!-- Social Register -->
                <div class="divider">
                    <span><?= lang('or_register_with') ?? 'أو سجل بواسطة' ?></span>
                </div>
