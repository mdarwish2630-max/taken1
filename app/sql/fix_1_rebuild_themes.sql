-- ============================================================================
-- الجزء الأول: إعادة بناء جدول الثيمات والطلبات
-- ============================================================================

SET FOREIGN_KEY_CHECKS = 0;

-- تحديث معرفات الثيمات في جدول tenants
...
-- حذف جدول الطلبات أولاً (لأنه يحتوي foreign key لـ themes)
